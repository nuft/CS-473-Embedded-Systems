	soc_system u0 (
		...
		.cam_controller_debug_pixfifodataout            (<connected-to-cam_controller_debug_pixfifodataout>),            //                             .debug_pixfifodataout
		...
		.sdram_bridge_0_conduit_end_debug_address       (<connected-to-sdram_bridge_0_conduit_end_debug_address>),       //   sdram_bridge_0_conduit_end.debug_address
		.sdram_bridge_0_conduit_end_debug_burstcount    (<connected-to-sdram_bridge_0_conduit_end_debug_burstcount>),    //                             .debug_burstcount
		.sdram_bridge_0_conduit_end_debug_byteenable    (<connected-to-sdram_bridge_0_conduit_end_debug_byteenable>),    //                             .debug_byteenable
		.sdram_bridge_0_conduit_end_debug_read          (<connected-to-sdram_bridge_0_conduit_end_debug_read>),          //                             .debug_read
		.sdram_bridge_0_conduit_end_debug_readdata      (<connected-to-sdram_bridge_0_conduit_end_debug_readdata>),      //                             .debug_readdata
		.sdram_bridge_0_conduit_end_debug_readdatavalid (<connected-to-sdram_bridge_0_conduit_end_debug_readdatavalid>), //                             .debug_readdatavalid
		.sdram_bridge_0_conduit_end_debug_waitrequest   (<connected-to-sdram_bridge_0_conduit_end_debug_waitrequest>),   //                             .debug_waitrequest
		.sdram_bridge_0_conduit_end_debug_write         (<connected-to-sdram_bridge_0_conduit_end_debug_write>),         //                             .debug_write
		.sdram_bridge_0_conduit_end_debug_writedata     (<connected-to-sdram_bridge_0_conduit_end_debug_writedata>)      //                             .debug_writedata
	);
