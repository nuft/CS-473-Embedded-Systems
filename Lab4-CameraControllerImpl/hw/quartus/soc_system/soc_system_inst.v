	soc_system u0 (
		...
		.cam_controller_0_conduit_end_d5m_d       (<connected-to-cam_controller_0_conduit_end_d5m_d>),       // cam_controller_0_conduit_end.d5m_d
		.cam_controller_0_conduit_end_d5m_fval    (<connected-to-cam_controller_0_conduit_end_d5m_fval>),    //                             .d5m_fval
		.cam_controller_0_conduit_end_d5m_lval    (<connected-to-cam_controller_0_conduit_end_d5m_lval>),    //                             .d5m_lval
		.cam_controller_0_conduit_end_d5m_pixclk  (<connected-to-cam_controller_0_conduit_end_d5m_pixclk>),  //                             .d5m_pixclk
		.cam_controller_0_conduit_end_d5m_reset_n (<connected-to-cam_controller_0_conduit_end_d5m_reset_n>), //                             .d5m_reset_n
		.cam_controller_0_conduit_end_d5m_xclkin  (<connected-to-cam_controller_0_conduit_end_d5m_xclkin>)   //                             .d5m_xclkin
	);
